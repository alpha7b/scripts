# curl -sL https://raw.githubusercontent.com/alpha7b/scripts/main/massaUpgrade_gha.sh -o massaUpgrade_gha.sh && sudo bash massaUpgrade_gha.sh
...
# # set vars --- all these vars will be passed from github actions
