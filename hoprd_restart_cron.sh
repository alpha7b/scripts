curl -sL https://raw.githubusercontent.com/alpha7b/scripts/main/hoprd_restart_cron.sh -o ~/hopr/hoprd_restart_cron.sh && sudo bash hoprd_restart_cron.sh $apiToken
#!/bin/bash
